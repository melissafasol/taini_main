...
for i in range(len(animal_number_two_brainstates)-1):
    ...
    print(animal_number)
    data_baseline1, data_baseline2, brain_state_1, brain_state_2, time_1, time_2 = loading_analysis_files(path, animal_number, starting_times_dict, channel_number=4)
...
for i in range(len(animal_number_one_brainstate)-1):
    ...
    data_baseline1, brain_state_1, time_1 = loading_analysis_files_onebrainstate(path, animal_number, starting_times_dict, channel_number=4)
    REM_1_timevalues = brainstate_times(brain_state_1, 2)
    REM_1_datavalues = channel_data_extraction(REM_1_timevalues, data_baseline1)
    REM_1_withoutartifacts = remove_noise(REM_1_datavalues)
    psd_REM_1, frequency = psd_per_channel(REM_1_withoutartifacts)
    psd_average_1 = psd_average(psd_REM_1, frequency, animal_number)
...
print(small_dfs_one_brainstate)
print(small_dfs_two_brainstates[7])
...
large_dfs_two_brainstates = pd.concat([small_dfs_two_brainstates[0], small_dfs_two_brainstates[1],
                                      ...
                                      small_dfs_two_brainstates[6], small_dfs_two_brainstates[7]], ignore_index=True)
...
large_dfs_one_brainstate = pd.concat([small_dfs_one_brainstate[0], small_dfs_one_brainstate[1],
                                    ...
                                    small_dfs_one_brainstate[4]],ignore_index=True)
