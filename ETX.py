...
for condition in recording_condition: 
    if condition == 'ETX':
        for brainstate in brainstate_number:
            ...
            save_directory = '/home/melissa/Results/march_refactor_test/ETX_results/two_numpy_file/no_epochs_discarded'
            ...
            save_directory = '/home/melissa/Results/march_refactor_test/ETX_results/one_numpy_file/no_epochs_discarded'
