...
for condition in recording_condition: 
    if condition == 'saline':
        for brainstate in brainstate_number:
            ...
            save_directory = '/home/melissa/Results/march_refactor_test/2_nonREM_epochs/two_numpy_files'
            ...
            save_directory = '/home/melissa/Results/march_refactor_test/2_nonREM_epochs/one_numpy_file'
